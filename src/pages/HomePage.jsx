  ...
  return (
    <>
      {/* ╔══════════════════════════════════════════════╗
          ║               NAVBAR                        ║
          ╚══════════════════════════════════════════════╝ */}
      <header className="sticky top-0 z-40 w-full bg-[#6d9cd0] text-white shadow-md">
        <div className="mx-auto flex h-[70px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center gap-1 text-[15px] font-semibold tracking-wide">
            <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="px-5 py-1 hover:text-blue-200 transition cursor-pointer">Home</button>
      ...
      <section className="relative w-full min-h-[85vh] flex flex-col items-start justify-center overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-[#0288d1]" style={{ backgroundImage: `url(${heroBg})` }} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
            {categories.map((cat) => (
              <button
                ...
                className="group relative flex flex-col text-left bg-white rounded-2xl shadow-sm hover:shadow-xl border border-slate-200/60 overflow-hidden transition-all duration-350 hover:-translate-y-1.5 cursor-pointer"
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  {/* Title */}
                  <h3 className="text-lg font-bold text-slate-850 group-hover:text-[#0288d1] transition-colors mb-2">
                    {t(cat.titleKey)}
                  </h3>
                  ...
                  {/* Learn More link */}
                  <div className="mt-5 flex items-center gap-1 text-[#0288d1] text-xs font-black group-hover:gap-2 transition-all">
          ...
          <div className="mx-auto max-w-7xl px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-slate-600">
                ...
                <p><span className="font-bold text-slate-800">Email:</span> dashrathbogati907@gmail.com</p>
